          ...
          >
                                      ...
                                      <a href='/CafeSupremo/blog/blogdetails/Blog/Blog_core_c4942f74-4f62-42cb-8de5-4a1b10a5c6b4/Our Pastries'>
                                        <div className='blog-overlay'>
                                          ...
                                          <div
                                            ...
                                            id='Blog_core_c4942f74-4f62-42cb-8de5-4a1b10a5c6b4-contentItem'
                                          >
                                            <div className='date'>
                                              May 9, 2017
                                            </div>
                                            ...
                                            <div className='description'>
                                              Get the perfect pastries to go
                                              with your prefect coffee
                                            </div>
                                          </div>
                                        </div>
                                      </a>
            ...
            <div className='block-container'>
              <ol className='blocks'>
                <li>
                  <p>
                    <a data-category='HOW TO'>HOW TO</a>
                  </p>
                  <ol>
                    <li>
                ...
                <li>
                  <p>
                    <a data-category='DRINKS'>DRINKS</a>
                  </p>
                  <ol>
                    <li>
                ...
                <li>
                  <p>
                    <a data-category='PEOPLE'>PEOPLE</a>
                  </p>
                  <ol>
                    <li>
                ...
                <li>
                  <p>
                    <a data-category='RECIPES'>RECIPES</a>
                  </p>
                  <ol>
                    <li>
...
const TopNav = () => (
  ...
  >
    <ul className='nav navbar-nav'>
      ...
      <li className='dropdown content-link contentmenu1-link'>
        <a
          className='dropdown-toggle'
          data-hover='dropdown'
