...
define([
		...
		searchResultsObject.items.forEach(function(searchResultsItem) {
			...
			if (SCSRenderAPI.renderMode === 'view') {
				if (layoutName === undefined) {
					layoutName = self.getLayoutName(searchResultsItem.type, layoutCategory);
				}
	...
	ComponentViewModel.prototype.getLayoutName = function(contentType, layoutCategory) {
		var layoutName;
		...
		var errorCallback = function(jqXHR, textStatus, errorThrown) {
			console.error("Can't get content layouts: ", jqXHR, textStatus, errorThrown);
		};
