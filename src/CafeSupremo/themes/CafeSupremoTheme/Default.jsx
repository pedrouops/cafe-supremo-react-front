...
class CookieConsent extends React.Component {
  ...
  render() {
    return this.state.hasConsented ? '': <div className="scs-cookie-consent" data-scs-consent-version="1">This site uses cookies. Please review our <a href="#">Privacy Policy</a>. <a href="#" alt="close" className="scs-cookie-consent-close" onClick={() => this.giveConsent()}></a></div>
  }
}
